import { toogleIsGrabbed, changeScrollButtonPosition, changeBarsPosition } from '../../src/js/views/pages/bars/actions/scrollActions.js';
import { handleInputChange } from '../../src/js/views/pages/bars/actions/searchActions.js';
