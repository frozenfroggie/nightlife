          ...
          <div className="socialBtns">
            <div className="socialBtn">
              ...
              <a href='/socialAuth/facebook'>
                <div className={classnames(['connect', {'connected': props.user.facebook && props.user.facebook.id}])}> { props.user.facebook && props.user.facebook.id ? 'Connected' : 'Connect'} </div>
              </a>
            </div>
            <div className="socialBtn">
              ...
              <a href='/socialAuth/google'>
                <div className={classnames(['connect', {'connected': props.user.google && props.user.google.id}])}> { props.user.google && props.user.google.id ? 'Connected' : 'Connect'} </div>
              </a>
            </div>
            <div className="socialBtn">
              ...
              <a href='/socialAuth/github'>
                <div className={classnames(['connect', {'connected': props.user.github && props.user.github.id}])}> { props.user.github && props.user.github.id ? 'Connected' : 'Connect'} </div>
              </a>
            </div>
          </div>
        </div>
